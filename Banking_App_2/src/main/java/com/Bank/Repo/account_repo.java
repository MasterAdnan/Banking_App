...
public interface account_repo extends JpaRepository<Account, Integer> {
	...
	List<Account> getUserAccountById(@Param("user_id")int string);
	...
	double getAccountBalance(@Param("user_id") String string, @Param("account_id") int account_id);
	...
	List<Account> getUserAccountsById(String user_id);
